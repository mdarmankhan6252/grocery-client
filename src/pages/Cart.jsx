...
const Cart = () => {
   ...
   return products.length > 0 && cartItems ? (
      <div>
         <div className="flex flex-col justify-center md:flex-row mt-16 mx-auto w-full">
               ...
               {cartArray.map((product, index) => (
                  <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                     ...
                     <button onClick={() => removeFromCart(product._id)} className="cursor-pointer mx-auto">
                        <img src={assets.remove_icon} alt="icon" className="inline-block w-6 h-6" />
                     </button>
                  </div>)
               )}

               <button onClick={() => navigate('/products')} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                  <img className="group-hover:-translate-x-1 transition" src={assets.arrow_right_icon_colored} alt="arrow_icon" />
                  Continue Shopping
               </button>
            ...
            <div className="">
               <div className="max-w-lg w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
