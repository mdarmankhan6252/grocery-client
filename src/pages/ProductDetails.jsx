      ...
      <div className="mt-16">
            ...
            <div className="text-sm w-full md:w-1/2">
               ...
               <div className="flex items-center gap-0.5 mt-1">
                  {Array(5).fill('').map((_, i) => (
                     (
                        <img src={i < 4 ? assets.star_icon : assets.star_dull_icon} key={i} className="md:w-4 w-3.5" />
                     )
                  ))}
         ...
         <div className="mt-24">
            <div className="flex flex-col items-center justify-center">
               <h3 className="text-2xl font-medium uppercase text-gray-900/70 pb-1">Related Products</h3>
            ...
            <div className="text-center">
               <button onClick={() => { navigate('/products'); scrollTo(0, 0) }} className="cursor-pointer  px-12 my-16 py-2.5 border rounded-sm text-pretty hover:bg-primary/10 transition border-primary text-primary">See More</button>
            </div>
         </div>
      </div>
   );
