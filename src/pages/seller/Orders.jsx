...
const Orders = () => {
   ...
   return (
      ...
      <div className="no-scrollbar overflow-y-scroll h-[calc(100vh-61px)] ">
         <div className="md:p-10 p-4 space-y-4">
            <h2 className="text-lg font-medium">Orders List</h2>
            {orders.map((order, index) => (
               <div key={index} className="flex flex-col md:items-center md:flex-row justify-between gap-5 p-5 xl:w-4xl max-w-4xl rounded-md border border-gray-300">
